        ...
        <div className="w-full lg:w-1/2 flex items-center justify-center p-6">
          ...
          >
            ...
            <div className="space-y-5">
              <div className="space-y-2">
                ...
                <input
                  ...
                  className="w-full bg-[#0a0a0a]/50 border border-white/10 rounded-xl px-4 py-3.5 text-white"
                  value={form.email}
                  onChange={(e) =>
            ...
            <button
              type="submit"
              disabled={loading}
              className="mt-4 w-full py-4 bg-gradient-to-r from-emerald-500 to-green-600 text-white font-bold text-lg rounded-xl disabled:opacity-50"
            >
